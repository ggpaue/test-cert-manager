...
if [[ "$K8S_VERSION" =~ 1\.16 ]] ; then
  ...
  KIND_IMAGE_SHA="sha256:2f93d3c7b12a3e93e6c1f34f331415e105979961fcddbe69a4e3ab5a93ccbb35"
else
  echo "Unrecognised Kubernetes version '${K8S_VERSION}'! Aborting..."
  exit 1
fi
export KIND_IMAGE_REPO="projects-stg.registry.vmware.com/tkg/sandbox/kind/node"
